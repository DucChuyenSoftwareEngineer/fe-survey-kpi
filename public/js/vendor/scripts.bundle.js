        ...
        build: function() {
            ...
            KTUtil.addEvent(the.input, 'change', function(e) {
	            ...
	            if (the.input && the.input.files && the.input.files[0]) {
	                ...
	                reader.onload = evt => {
	                    KTUtil.css(the.wrapper, 'background-image', `url(${evt.target.result})`);
	                }
...
var KTLayoutPanel = function() {
    ...
    var _init = function() {
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            baseClass: 'offcanvas',
            placement: 'right',
            closeBy: 'kt_panel_close',
            toggleBy: 'kt_panel_toggle'
        });
        ...
        if (typeof offcanvas !== 'undefined' && offcanvas.length === 0) {
            offcanvas.on('hide', function() {
                ...
                KTCookie.setCookie('kt_panel_shown', 1, {expires: expires});
            });
        }
    }
    ...
    var _remind = function() {
        ...
        setTimeout(function() {
            if (!KTCookie.getCookie('kt_panel_shown')) {
...
var KTLayoutQuickUser = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
			...
			toggleBy: ['kt_quick_user_toggle_desktop','kt_quick_user_toggle_mobile']
        });
...
var KTCardTools = function() {
	var _init = function() {
		...
		$lstCard = $("div[id^=kt_card]")
		$.each($lstCard, function() {
			var card = new KTCard($(this).attr("id"));
